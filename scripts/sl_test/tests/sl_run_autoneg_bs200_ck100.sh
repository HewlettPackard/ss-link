...
brief="Test auto-negotiation selects fastest speed: bs200 and ck100 enabled (should select bs200g)."
...
function main {
	...
	sl_test_info_log "${FUNCNAME}" \
		"lgrp_setup (ldev_num = ${ldev_num}, lgrp_nums = (${lgrp_nums[*]}), tech_map_bs200g=${tech_map_bs200g_set} ck100g=${tech_map_ck100g_set})"

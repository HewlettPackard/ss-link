...
brief="Test auto-negotiation selects fastest speed: bj100 and cd50 enabled (should select bj100g)."
...
function main {
	...
	sl_test_info_log "${FUNCNAME}" \
		"lgrp_setup (ldev_num = ${ldev_num}, lgrp_nums = (${lgrp_nums[*]}), tech_map_bj100g=${tech_map_bj100g_set} cd50g=${tech_map_cd50g_set})"

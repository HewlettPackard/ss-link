...
brief="Test auto-negotiation selects fastest speed: ck200 and bj100 enabled (should select ck200g)."
...
function main {
	...
	sl_test_info_log "${FUNCNAME}" \
		"lgrp_setup (ldev_num = ${ldev_num}, lgrp_nums = (${lgrp_nums[*]}), tech_map_ck200g=${tech_map_ck200g_set} bj100g=${tech_map_bj100g_set})"

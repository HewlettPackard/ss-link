...
brief="Test auto-negotiation selects fastest speed: ck400 and cd50 enabled (should select ck400g)."
...
function main {
	...
	sl_test_info_log "${FUNCNAME}" \
		"lgrp_setup (ldev_num = ${ldev_num}, lgrp_nums = (${lgrp_nums[*]}), tech_map_ck400g=${tech_map_ck400g_set} cd50g=${tech_map_cd50g_set})"

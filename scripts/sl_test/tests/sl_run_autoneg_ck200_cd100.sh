...
brief="Test auto-negotiation selects fastest speed: ck200 and cd100 enabled (should select ck200g)."
...
function main {
	...
	sl_test_info_log "${FUNCNAME}" \
		"lgrp_setup (ldev_num = ${ldev_num}, lgrp_nums = (${lgrp_nums[*]}), tech_map_ck200g=${tech_map_ck200g_set} cd100g=${tech_map_cd100g_set})"

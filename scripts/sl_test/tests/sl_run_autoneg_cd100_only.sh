...
brief="Test auto-negotiation selects fastest speed: cd100 only enabled (should select cd100)."
...
function main {
	...
	sl_test_info_log "${FUNCNAME}" \
		"lgrp_setup (ldev_num = ${ldev_num}, lgrp_nums = (${lgrp_nums[*]}), tech_map_cd100g=${tech_map_cd100g_set})"

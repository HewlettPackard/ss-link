...
brief="Test auto-negotiation selects fastest speed: ck100 only enabled (should select ck100)."
...
function main {
	...
	sl_test_info_log "${FUNCNAME}" \
		"lgrp_setup (ldev_num = ${ldev_num}, lgrp_nums = (${lgrp_nums[*]}), tech_map_ck100g=${tech_map_ck100g_set})"

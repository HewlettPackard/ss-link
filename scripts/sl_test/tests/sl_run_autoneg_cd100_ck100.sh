...
brief="Test auto-negotiation selects fastest speed: cd100 and ck100 enabled (should select cd100g)."
...
function main {
	...
	sl_test_info_log "${FUNCNAME}" \
		"lgrp_setup (ldev_num = ${ldev_num}, lgrp_nums = (${lgrp_nums[*]}), tech_map_cd100g=${tech_map_cd100g_set} ck100g=${tech_map_ck100g_set})"

#!/usr/bin/env bash
#
# Copyright 2022,2023 Hewlett Packard Enterprise Development LP. All rights reserved.
#
...
sed -i -e "s/%define release_extra.*/%define release_extra ${PRODUCT_LABEL}${PRODUCT_VERSION}/g" sl-driver.spec

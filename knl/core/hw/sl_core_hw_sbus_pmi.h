...
#define SL_CORE_HW_SBUS_PMI_RD(_lgrp, _dev_addr, _dev_id, _lane, _pll, _addr, _mask, _data)                     \
	do {                                                                                                    \
		rtn = sbus_pmi_rd((_lgrp), (_dev_addr), (_dev_id), (_lane), (_pll), (_addr), (_mask), (_data)); \
		if (rtn != 0)                                                                                   \
			goto out;                                                                               \
	} while (0)

#define SL_CORE_HW_SBUS_PMI_WR(_lgrp, _dev_addr, _dev_id, _lane, _pll, _addr, _data, _mask)                     \
	do {                                                                                                    \
		rtn = sbus_pmi_wr((_lgrp), (_dev_addr), (_dev_id), (_lane), (_pll), (_addr), (_data), (_mask)); \
		if (rtn != 0)                                                                                   \
			goto out;                                                                               \
	} while (0)

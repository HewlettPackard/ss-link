...
#define SL_CORE_HW_UC_RAM_WR8(_lgrp, _dev_id, _lane, _addr, _data)                          \
	do {                                                                                \
		rtn = sl_core_hw_uc_ram_wr8((_lgrp), (_dev_id), (_lane), (_addr), (_data)); \
		if (rtn != 0)                                                               \
			goto out;                                                           \
	} while (0)

#define SL_CORE_HW_UC_RAM_RD8(_lgrp, _dev_id, _lane, _addr, _data)                          \
	do {                                                                                \
		rtn = sl_core_hw_uc_ram_rd8((_lgrp), (_dev_id), (_lane), (_addr), (_data)); \
		if (rtn != 0)                                                               \
			goto out;                                                           \
	} while (0)

...
#define SL_MEDIA_FURCATION_UNKNOWN 0
...
#define SL_MEDIA_TYPE_UNSUPPORTED   BIT(29)
#define SL_MEDIA_TYPE_UNKNOWN       BIT(30)
...
enum sl_media_shape {
	SL_MEDIA_SHAPE_STRAIGHT    = 1,
	SL_MEDIA_SHAPE_SPLITTER,
	SL_MEDIA_SHAPE_BIFURCATED,
	SL_MEDIA_SHAPE_UNKNOWN,
};

#define SL_MEDIA_CABLE_END_DD      0x41
#define SL_MEDIA_CABLE_END_END1    0x42
#define SL_MEDIA_CABLE_END_END2    0x43
...
#define SL_MEDIA_SPEEDS_SUPPORT_CK_1600G BIT(8) /* FIXME: CK1600 is temporary placeholder */
...
#define SL_MEDIA_INFO_SUPPORTED_SS200_CABLE  BIT(4)

#define SL_MEDIA_ERROR_CABLE_UNSUPPORTED        BIT(0)
#define SL_MEDIA_ERROR_CABLE_FORMAT_UNSUPPORTED BIT(1)
#define SL_MEDIA_ERROR_CABLE_FW_UNSUPPORTED     BIT(2)
#define SL_MEDIA_ERROR_CABLE_HEADSHELL_FAULT    BIT(3)
#define SL_MEDIA_ERROR_TEMP_DOWN_LIMIT_DEFAULT  BIT(4)
#define SL_MEDIA_ERROR_TEMP_WARN_LIMIT_DEFAULT  BIT(5)
...
#define SL_MEDIA_QSFP_DENSITY_UNKNOWN  4
...
#define SL_MEDIA_JACK_TYPE_UNKNOWN     5
#define SL_MEDIA_JACK_TYPE_UNSUPPORTED 6

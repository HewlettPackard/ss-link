...
enum sl_link_pml_rec_counters {
	...
	// FIXME: the causes need to be named better
	SL_LINK_PML_REC_LINK_LOCAL_FAULT_CAUSE,
	SL_LINK_PML_REC_LINK_DOWN_CAUSE,
	SL_LINK_PML_REC_LINK_REMOTE_FAULT_CAUSE,
...
#define SL_LINK_DOWN_CAUSE_LOOPBACK_IO                BIT(42) /* IO error setting loopback in media         */
#define SL_LINK_DOWN_CAUSE_LOOPBACK_UNSUPPORTED       BIT(43) /* Loopback configuration not supported       */

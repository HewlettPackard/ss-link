...
#define SL_LINK_DOWN_CAUSE_FEC_CONFIG_MAP (                     \
		...
		SL_LINK_DOWN_ORIGIN_LINK_UP                   | \
		SL_LINK_DOWN_RETRYABLE)
#define SL_LINK_DOWN_CAUSE_LOOPBACK_IO_MAP (                    \
		SL_LINK_DOWN_CAUSE_LOOPBACK_IO                | \
		SL_LINK_DOWN_ORIGIN_LINK_UP                   | \
		SL_LINK_DOWN_RETRYABLE)
#define SL_LINK_DOWN_CAUSE_LOOPBACK_CONFIG_MAP (                \
		SL_LINK_DOWN_CAUSE_LOOPBACK_CONFIG            | \
		SL_LINK_DOWN_ORIGIN_LINK_UP                   | \
		SL_LINK_DOWN_RETRYABLE)
#define SL_LINK_DOWN_CAUSE_LOOPBACK_UNSUPPORTED_MAP (           \
		SL_LINK_DOWN_CAUSE_LOOPBACK_UNSUPPORTED       | \
		SL_LINK_DOWN_ORIGIN_LINK_UP                   | \
		SL_LINK_DOWN_RETRYABLE)
#define SL_LINK_DOWN_CAUSE_PARTNER_LOOPBACK_ON_MAP (            \
		SL_LINK_DOWN_CAUSE_PARTNER_LOOPBACK_ON        | \
		SL_LINK_DOWN_ORIGIN_ASYNC                     | \
		SL_LINK_DOWN_RETRYABLE)
#define SL_LINK_DOWN_CAUSE_PARTNER_LOOPBACK_MISMATCH_MAP (      \
...
#define SL_LINK_DEGRADE_STATE_TURNED_OFF 4

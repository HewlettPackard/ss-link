...
#define SS2_PORT_PML_CFG_RX_PCS_RESTART_LOCK_ON_BAD_AMS_GET(a)                       SL_CSR_GET(a, ss2_port_pml_cfg_rx_pcs, restart_lock_on_bad_ams)
...
#define SS2_PORT_PML_CFG_RX_PCS_RESTART_LOCK_ON_BAD_CWS_GET(a)                       SL_CSR_GET(a, ss2_port_pml_cfg_rx_pcs, restart_lock_on_bad_cws)

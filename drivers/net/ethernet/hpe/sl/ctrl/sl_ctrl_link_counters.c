...
int sl_ctrl_link_cause_counters_init(struct sl_ctrl_link *ctrl_link)
{
	...
	SL_CTRL_LINK_CAUSE_COUNTER_INIT(ctrl_link, LINK_CAUSE_INTR_UP_ENABLE);
	SL_CTRL_LINK_CAUSE_COUNTER_INIT(ctrl_link, LINK_CAUSE_INTR_HIGH_SER_ENABLE);
	SL_CTRL_LINK_CAUSE_COUNTER_INIT(ctrl_link, LINK_CAUSE_INTR_LLR_STARVED_ENABLE);
	SL_CTRL_LINK_CAUSE_COUNTER_INIT(ctrl_link, LINK_CAUSE_INTR_LLR_MAX_STARVE_ENABLE);
	SL_CTRL_LINK_CAUSE_COUNTER_INIT(ctrl_link, LINK_CAUSE_INTR_FAULT_ENABLE);
	SL_CTRL_LINK_CAUSE_COUNTER_INIT(ctrl_link, LINK_CAUSE_INTR_LANE_DEGRADE_ENABLE);
	...
	SL_CTRL_LINK_CAUSE_COUNTER_INIT(ctrl_link, LINK_CAUSE_LOOPBACK_IO);
	SL_CTRL_LINK_CAUSE_COUNTER_INIT(ctrl_link, LINK_CAUSE_LOOPBACK_CONFIG);
	SL_CTRL_LINK_CAUSE_COUNTER_INIT(ctrl_link, LINK_CAUSE_LOOPBACK_UNSUPPORTED);
	SL_CTRL_LINK_CAUSE_COUNTER_INIT(ctrl_link, LINK_CAUSE_PARTNER_LOOPBACK_ON);
	SL_CTRL_LINK_CAUSE_COUNTER_INIT(ctrl_link, LINK_CAUSE_PARTNER_LOOPBACK_MISMATCH);
	SL_CTRL_LINK_CAUSE_COUNTER_INIT(ctrl_link, LINK_CAUSE_LOOPBACK_MEDIA_ON);
...
void sl_ctrl_link_cause_counter_inc(struct sl_ctrl_link *ctrl_link, u64 cause_map)
{
	...
	for_each_set_bit(which, (unsigned long *)&cause_map, sizeof(cause_map) * BITS_PER_BYTE) {
		...
		case SL_LINK_DOWN_CAUSE_INTR_UP_ENABLE:
			SL_CTRL_LINK_CAUSE_COUNTER_INC(ctrl_link, LINK_CAUSE_INTR_UP_ENABLE);
			break;
		case SL_LINK_DOWN_CAUSE_INTR_HIGH_SER_ENABLE:
			SL_CTRL_LINK_CAUSE_COUNTER_INC(ctrl_link, LINK_CAUSE_INTR_HIGH_SER_ENABLE);
			break;
		case SL_LINK_DOWN_CAUSE_INTR_LLR_STARVED_ENABLE:
			SL_CTRL_LINK_CAUSE_COUNTER_INC(ctrl_link, LINK_CAUSE_INTR_LLR_STARVED_ENABLE);
			break;
		case SL_LINK_DOWN_CAUSE_INTR_LLR_MAX_STARVE_ENABLE:
			SL_CTRL_LINK_CAUSE_COUNTER_INC(ctrl_link, LINK_CAUSE_INTR_LLR_MAX_STARVE_ENABLE);
			break;
		case SL_LINK_DOWN_CAUSE_INTR_FAULT_ENABLE:
			SL_CTRL_LINK_CAUSE_COUNTER_INC(ctrl_link, LINK_CAUSE_INTR_FAULT_ENABLE);
			break;
		case SL_LINK_DOWN_CAUSE_INTR_LANE_DEGRADE_ENABLE:
			SL_CTRL_LINK_CAUSE_COUNTER_INC(ctrl_link, LINK_CAUSE_INTR_LANE_DEGRADE_ENABLE);
			break;
		...
		case SL_LINK_DOWN_CAUSE_LOOPBACK_IO:
			SL_CTRL_LINK_CAUSE_COUNTER_INC(ctrl_link, LINK_CAUSE_LOOPBACK_IO);
			break;
		case SL_LINK_DOWN_CAUSE_LOOPBACK_CONFIG:
			SL_CTRL_LINK_CAUSE_COUNTER_INC(ctrl_link, LINK_CAUSE_LOOPBACK_CONFIG);
			break;
		case SL_LINK_DOWN_CAUSE_LOOPBACK_UNSUPPORTED:
			SL_CTRL_LINK_CAUSE_COUNTER_INC(ctrl_link, LINK_CAUSE_LOOPBACK_UNSUPPORTED);
			break;
		case SL_LINK_DOWN_CAUSE_PARTNER_LOOPBACK_ON:
			SL_CTRL_LINK_CAUSE_COUNTER_INC(ctrl_link, LINK_CAUSE_PARTNER_LOOPBACK_ON);
			break;
		case SL_LINK_DOWN_CAUSE_PARTNER_LOOPBACK_MISMATCH:
			SL_CTRL_LINK_CAUSE_COUNTER_INC(ctrl_link, LINK_CAUSE_PARTNER_LOOPBACK_MISMATCH);
			break;
		case SL_LINK_DOWN_CAUSE_LOOPBACK_MEDIA_ON:
			SL_CTRL_LINK_CAUSE_COUNTER_INC(ctrl_link, LINK_CAUSE_LOOPBACK_MEDIA_ON);
			break;
